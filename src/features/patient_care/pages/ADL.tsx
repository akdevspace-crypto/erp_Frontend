...
import { useAdlRecords, useCreateAdlRecord, useHealthcarePatients, useUpdateAdlStatus } from '../../healthcare/hooks/useHealthcare'
import type { AdlRecord } from '../../healthcare/types'
