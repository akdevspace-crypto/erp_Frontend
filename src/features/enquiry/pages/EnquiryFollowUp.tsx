    ...
    return (
        <div className="flex min-h-full flex-col bg-transparent dark:bg-black">
            ...
            <section className="mb-3 shrink-0">
                ...
                <div className="rounded-xl border border-gray-100 bg-white p-2 shadow-sm dark:border-white/10 dark:bg-black">
                    ...
                    <DataTable
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="ml-2 flex items-center gap-1.5">
                                ...
                                <button onClick={() => { setEnquiryToDelete(e); setDeleteModalOpen(true) }} className="rounded bg-rose-500 p-1.5 text-white shadow-sm transition-colors hover:bg-rose-600" title="Delete">
            ...
            <EnquiryFollowUpModal
                ...
                enquiry={localEnquiries.find(e => e.id === enquiryToFollowUp?.id) || enquiryToFollowUp}
