...
export function StaffRegister() {
    ...
    const handleStaffSelect = (staff: any) => {
        setFormData((current) => ({
            ...current,
            staffName: staff.firstName ? `${staff.firstName} ${staff.lastName || ''}`.trim() : staff.name || '',
            empId: staff.empId || '',
        ...
        <div className="flex h-full flex-col space-y-6 bg-transparent">
            ...
            <form onSubmit={handleSubmit} className="rounded-3xl border border-slate-100 bg-white p-4 shadow-sm">
                ...
                <div className="grid gap-3 md:grid-cols-3">
                    ...
                    <Input label="Staff Name" value={formData.staffName} readOnly required className="bg-gray-50 text-gray-500 cursor-not-allowed" />
                    <Input label="Employee ID" value={formData.empId} readOnly required className="bg-gray-50 text-gray-500 cursor-not-allowed" />
                    <Input label="Mobile" value={formData.mobile} readOnly className="bg-gray-50 text-gray-500 cursor-not-allowed" />
                    <Input label="Department" value={formData.department} readOnly className="bg-gray-50 text-gray-500 cursor-not-allowed" />
                    <Input label="Designation" value={formData.designation} readOnly className="bg-gray-50 text-gray-500 cursor-not-allowed" />
