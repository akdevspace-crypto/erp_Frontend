...
export function AdmissionTracking() {
    ...
    const [contractAdmission, setContractAdmission] = useState<AdmissionRecord | null>(null)
    ...
    return (
        <div className="flex h-full flex-col bg-transparent dark:bg-black">
            ...
            <DataTable
                ...
                actions={(admission) => (
                    <div className="flex gap-2">
                        <button
                            onClick={() => setContractAdmission(admission)}
                            className="inline-flex items-center rounded-lg bg-emerald-600 px-3 py-2 text-xs font-bold text-white shadow-sm hover:bg-emerald-700"
                        >
            ...
            <ServiceContractModal 
                isOpen={Boolean(contractAdmission)}
                onClose={() => setContractAdmission(null)}
