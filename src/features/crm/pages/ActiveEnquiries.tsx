...
export function ActiveEnquiries() {
    ...
    const handleConvert = () => {
        ...
        if (!unitId) {
            alert('Please select a Destination Care Facility.')
            return
        }
            ...
            >
                <div className="mt-3 space-y-4 text-left">
                    ...
                    <div className="mt-4 border-t pt-4">
                        ...
                        <div className="mb-4">
                            <label className="block text-xs font-bold text-gray-700 dark:text-gray-300">
                                Destination Care Facility <span className="text-red-500">*</span>
                            </label>
                            <div className="mt-1">
                                <MasterDataSelector type="units" value={unitId} onChange={(id) => setUnitId(id)} />
                            </div>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                            <label className="block text-xs font-bold text-gray-700 dark:text-gray-300">
